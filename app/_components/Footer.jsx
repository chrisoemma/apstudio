    ...
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
      <div>
        <p>
          ...
          <a href="#" className="block text-2xl font-medium text-gray-900 hover:opacity-75 sm:text-2xl">
           +255 713 500 807
          </a>
        </p>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            ...
            <li>
              <a href="/packages" className="text-gray-700 transition hover:opacity-75"> AP Packages</a>
            </li>

            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Decorations</a>
            </li>
        ...
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
          <li>
              <a href="/packages" className="text-gray-700 transition hover:opacity-75"> Packages </a>
            </li>
            <li>
    ...
    <div className="mt-12 border-t border-gray-100 pt-12">
      ...
      <ul className="mt-8 flex gap-6">
        ...
        <p className="mt-8 text-xs text-gray-500 sm:mt-0">
          &copy; 2025 AP Studio. All rights reserved.
        </p>
      </div>
    </div>
  </div>
